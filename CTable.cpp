...
CTable CTable::operator+(const CTable &pcOther) {
	...
	CTable newCT = CTable(DEFAULT_NAME, i_table_length + pcOther.i_table_length);
...
//CTable& CTable::operator<<(const int iOffset) {
//	for (int i = 0; i < this->i_table_length; i++) {
//		if (i + iOffset < this->i_table_length) {
//			pi_table[i] = pi_table[i + iOffset];
//		}
//		else {
//			pi_table[i] = 0;
//		}
